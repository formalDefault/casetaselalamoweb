...
function Accesorios() {
    ...
    const tarjetas = (imagen, Titulo, Descripcion) => {
        ...
        return(
            <div>
                <div onClick={() => handleChange()} className="z-10 bg-blue-600 border rounded-lg shadow-lg xl:w-8/12 xl:m-auto xl:cursor-pointer xl:shadow-xl xl:hover:mb-8">
                    <img src={imagen} alt="imagen" className="rounded-t-lg object-cover h-24 w-full bg-white xl:h-48 "/>
    ...
    const elementos = () => {
        return (
            <div className="grid grid-cols-2 gap-4 p-4 xl:grid-cols-3 xl:p-8 xl:pt-28">
