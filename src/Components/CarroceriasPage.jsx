...
function CarroceriasPage() {
    var styleTarjeta = "text-left bg-blue-600 rounded-xl m-auto sm:w-full sm:h-full xl:w-8/12"
    ...
    return (
        <div className="p-4"> 
            ...
            <div className="grid grid-cols-2 gap-4 xl:grid-cols-3 sm:grid-cols-3 md:grid-cols-2 xl:w-11/12 xl:m-auto xl:mt-20">
